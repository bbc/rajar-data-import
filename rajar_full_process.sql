...
create table rajar.replist_temp as (select file_quarter,
                                           report_id,
                                           report_name,
                                           station_code,
                                           reporting_period,
...
delete from rajar.summary_table_2 where quarter in (select distinct file_quarter from rajar.replist_temp);
insert into rajar.summary_table_2 with listens as (select file_quarter     as quarter,
                                                               report_name      as station,
                                                               bbc_or_commercial,
                                                               reporting_period,
                                                               respid,
...
delete from rajar.second_summary where file_quarter in (select distinct file_quarter from rajar.replist_temp);
insert into rajar.second_summary select a.file_quarter,
                                             a.respid,
                                             a.dayofweek,
                                             a.station_code,
                                             a.location,
...
delete from rajar.rajar_population where file_quarter in (select distinct file_quarter from rajar.replist_temp);
insert into rajar.rajar_population select rw.file_quarter,
                                               reporting_period,
